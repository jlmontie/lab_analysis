...
# Diluted Hi 2nd batch
hi_ic_fqo = 'FastQataloguer_HighIC_2_2020-01-29.csv'
hi_ic_results_dir = '/data/analysis_group1/idbd_rnd/results/200128_NB551543_0206_AH2M7LAFX2/'
hi_ic_lib_dict_ls = get_lib_dict_ls(results_dir=hi_ic_results_dir, fqo=hi_ic_fqo)
hi_ic_df = pd.DataFrame(hi_ic_lib_dict_ls)
hi_ic_df.to_csv('high_ic_2_results.csv', index=False)
